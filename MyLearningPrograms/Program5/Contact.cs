...
namespace Program5
{
    public class Contact
    {
        ...
        //public Contact(int id, string name, string lastName, string email, int age, string address, bool isFavorite)
        //{
        //    Id = id;
        //    Name = name;
        //    LastName = lastName;
        ...
        public static void AddNewContact(List<Contact> contacts)
        {
            ...
            var contact = CreateContact(id, name, lastName, email, age, address, isFavorite);
            contacts.Add(contact);
        }
         
        public static Contact CreateContact(int id, string name, string lastName, string email, int age, string address, bool isFavorite)
        {
            return new Contact
            {
                Id = id,
        ...
        public static List<Contact> GetContactsByParameter(List<Contact> contacts, string searchCriteria)
        {
            ...
            //return contacts.Where(c => c.Name == searchCriteria || c.LastName == searchCriteria || c.Email == searchCriteria).ToList();
